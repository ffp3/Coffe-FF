...
**** Make sure you get the right verson for your windows ****

You can find out what version you have from Start -> Control Pannel -> System -> System type.
...
You probably have x64 (64 bit) windows vista or windows 7, please visit the files page on sourceforge
...
Done: Saves the settings properly now. Upload speeds to 200,000 are now suported. Only one copy of the program can be open at one time.

***** 1.0.2 ******

TODO: Find out how to do the "One or more programs require the system" like MCE standby Tool

Done: Auto Minimise on startup now Default Behaviour with "Run with Windows" IMPORTANT: Click this button twice after installing it if you were using 1.0.1
